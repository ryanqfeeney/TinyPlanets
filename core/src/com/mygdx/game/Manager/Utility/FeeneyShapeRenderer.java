 ...
 * @author stbachmann
 * @author Nathan Sweet */
public class FeeneyShapeRenderer implements Disposable {
    ...
    public FeeneyShapeRenderer () {
        this(5000);
    }

    public FeeneyShapeRenderer (int maxVertices) {
        this(maxVertices, null);
    }

    public FeeneyShapeRenderer (int maxVertices, ShaderProgram defaultShader) {
    ...
    /** Draws a polyline in the x/y plane using {@link FeeneyShapeRenderer.ShapeType#Line}. The vertices must contain at least 2 points (4 floats x,y). */
    public void polyline (float[] vertices, int offset, int count) {
        ...
        check(FeeneyShapeRenderer.ShapeType.Line, null, count);
        float colorBits = color.toFloatBits();
