...
////////////////////////////////////////////////////
    ...
    double semiA, semiB, ecc, w, Eanom, Manom, Tanom, startAnom, tManom;
    Point2D eccVecc;
...
//        state.vel = new Point2D(Math.cos(Math.PI/4)*sp*2805.800 ,-Math.sin(Math.PI/4)*sp*2805.800);
        ...
        state.pos = new Point2D(parentBody.getX() + 900_000 , parentBody.getY()+ 900_000);
        state.vel = new Point2D(0,0+sp*2805.800);
    ...
    public void moveOnOrbit(float dt) {
        ...
        if (ecc < 1.0) {
            ...
            ;
            double q = this.t / 100000000 + startAnom;
...
//            state.vel =
//                    new Point2D((2 * (state.pos.x() - parentBody.getX() + semiA)) / (semiA * semiA),
//                            (-2 * (state.pos.y() - parentBody.getY())) / (semiB * semiB));
